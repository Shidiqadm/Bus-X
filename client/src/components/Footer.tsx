      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          {/* <div>
            ...
            <p className="text-gray-600 mb-4">Subscribe to our newsletter for travel tips and exclusive offers.</p>
            ...
            <p className="text-gray-600 text-sm">We respect your privacy. No spam, ever.</p>
          </div> */}
        </div>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-gray-700 hover:text-[#FF8B00] transition duration-300 text-sm">
                Privacy Policy
              </a>
              <a href="#" className="text-gray-700 hover:text-[#FF8B00] transition duration-300 text-sm">
                Terms of Service
